...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: m1KhzMUisPmO/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__jSz0J, {
          [sty.freeBoxlong__jSz0Jiisyb]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__pseX, {
          [sty.freeBoxlong__pseXiisyb]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__kd6TJ)}
              role={"img"}
            />
          ),
