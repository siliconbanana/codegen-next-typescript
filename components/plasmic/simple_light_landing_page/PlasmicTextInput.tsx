...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: NZx1vNS3nMuD/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__whCml)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg___9Pidc)}
              role={"img"}
            />
          ),
