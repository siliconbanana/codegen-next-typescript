...
import Avatar from "../../Avatar"; // plasmic-import: 4Y8qhcHnK_fd/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: glVlAsquub51/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: zU7AgkNoo3Fp/icon
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__b10UC)}>
        <div
          className={classNames(
            projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__qtYty)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
