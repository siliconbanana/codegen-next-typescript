...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: wGtWS7hGhxSC/css
...
function PlasmicFaq__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__c3E9W)}>
        <div className={classNames(projectcss.all, sty.freeBox__is6Iy)}>
          <div className={classNames(projectcss.all, sty.freeBox__mK0Oi)}>
            {renderPlasmicSlot({
